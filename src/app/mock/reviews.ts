...
export const mockReviews: Review[] = [
  // Nike reviews
  {
    ...
    body: 'Nike consistently delivers high-quality athletic wear. Their shoes are incredibly comfortable and durable. I have been using Nike products for years and they never disappoint. The innovation in their designs keeps getting better.',
  ...
  },
  {
    ...
    body: 'Great quality products but quite expensive. The designs are trendy and the materials feel premium. Customer service could be better. Overall satisfied with my purchases.',
  ...
  // Apple reviews
  {
    ...
    body: 'Apple products are simply the best in terms of build quality and user experience. The ecosystem is seamless and everything works together perfectly. Yes, they are expensive, but you get what you pay for.',
  ...
  },
  {
    ...
    body: 'While Apple products are well-designed and functional, the pricing is simply too high for what you get. There are comparable alternatives at much lower prices. The brand premium is excessive.',
  ...
  // iPhone 15 Pro reviews
  {
    ...
    body: 'The iPhone 15 Pro is absolutely incredible. The camera system is phenomenal, especially the new zoom capabilities. The titanium design feels premium and the performance is blazing fast. Worth every penny.',
  ...
  },
  {
    ...
    body: 'Excellent phone overall. The camera is outstanding and the build quality is top-notch. However, it gets quite warm during intensive tasks and the price is steep. Still a solid upgrade.',
  ...
  // Sony headphones reviews
  {
    ...
    body: 'These are hands down the best noise canceling headphones I have ever used. The sound quality is exceptional and the comfort is unmatched for long listening sessions. Battery life is impressive too.',
  ...
  // MacBook Air M2 reviews
  {
    ...
    body: 'The M2 MacBook Air is the perfect laptop for most people. It is incredibly fast, silent, and has amazing battery life. The design is sleek and portable. Great for work, creativity, and entertainment.',
  ...
  // Oppenheimer reviews
  {
    ...
    body: 'Christopher Nolan has created another masterpiece. The storytelling is gripping, the performances are outstanding, and the technical aspects are flawless. A must-watch film that makes you think deeply.',
  ...
  // Barbie reviews
  {
    ...
    body: 'Much more than just a fun movie. It has depth, humor, and important messages about identity and society. Greta Gerwig did an amazing job balancing entertainment with substance.',
  ...
  // Dune reviews
  {
    ...
    body: 'Denis Villeneuve has delivered an epic continuation to the Dune saga. The scale is massive, the visuals are stunning, and the story is compelling. A perfect blend of action, politics, and philosophy.',
  ...
  // Taylor Swift album reviews
  {
    ...
    body: 'Taylor Swift continues to evolve and surprise with Midnights. The songwriting is exceptional and the production is polished. Each track tells a story and the album flows beautifully.',
  ...
  // Harry Styles album reviews
  {
    ...
    body: 'Harry House is a solid pop album with some great tracks. The production is slick and Harry vocals are strong. While not every track is a hit, the overall experience is enjoyable.',
  ...
  // Beyoncé album reviews
  {
    ...
    body: 'Renaissance is a masterpiece that celebrates dance music and Black queer culture. Beyoncé has created something truly special that honors the past while pushing boundaries. Every track is meticulously crafted.',
